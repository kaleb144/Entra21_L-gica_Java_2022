package br.com.entra21.exercicios.matrizes;
...
public class Main {
	...
	public static String escreverMenu() {
		...
		menu += "\t0 - Sair\n";
		menu += "\t1 - Criar matrizes de 2 níveis \n";
		menu += "\t2 - Inicializar matriz de dois níveis \n ";
		menu += "\t3 - Criar uma nova matriz de cinco vetores com três posições \n";
		menu += "\t4 - Criar matrizes de vetores conforme vontade de usuário \n";
		menu += "\t5 - Atribuir aleatoriamente valores e detalhes dos Vetores";
